            ...
            <div class="logo">
                <h1>
                    <a href="${pageContext.request.contextPath}/index.jsp">
                        <img class="logo-img center-block" src="/images/logo.png" alt="" /> 流浪动物救助
                    </a>
                </h1>
            </div>
...
<section class="footer-w3">
    <div class="container">
        <div class="col-lg-4 col-md-4 col-sm-4 footer-agile1" data-aos="zoom-in">
            <h3>网站简介</h3>
            <p class="footer-p1">
                该网站是用于想领养流浪动物和想成为我们其中一员，那么你将再这里实现你的想法。
                如果你是领养者，请认真选取想要领养的流浪动物领养后，请认真负责对待可爱的动物！
