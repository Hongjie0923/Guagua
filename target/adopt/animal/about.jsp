        ...
        <div class="about-top w3ls-agile">
            ...
            <div class="col-md-6 come">
                <div class="about-wel">
                    ...
                    <ul>
                        <li>
                            <i class="glyphicon glyphicon-ok"></i>动物的健康和关怀</li>
                        <li>
                            <i class="glyphicon glyphicon-ok"></i>动物的美容</li>
                        <li>
                            <i class="glyphicon glyphicon-ok"></i>动物的食物</li>
                        <li>
                            <i class="glyphicon glyphicon-ok"></i>动物的行为</li>
                    </ul>
                </div>
    ...
    <div class="agileinfo-gallery-row">
        <div class="col-md-3 col-sm-3 col-xs-4 w3gallery-grids">
            <a href="/images/g1.jpg" class="imghvr-hinge-right figure">
                <img src="/images/g1.jpg" alt="" title="Cat Life Image" />
            </a>
        </div>
        <div class="col-md-3 col-sm-3 col-xs-4 w3gallery-grids">
        ...
        <div class="col-md-3 col-sm-3 col-xs-4 w3gallery-grids">
            <a href="/images/g4.jpg" class="imghvr-hinge-right figure">
                <img src="/images/g4.jpg" alt="" title="Cat Life Image" />
            </a>
        </div>
        <div class="col-md-3 col-sm-3 col-xs-4 w3gallery-grids">
            <a href="/images/g5.jpg" class="imghvr-hinge-right figure">
                <img src="/images/g5.jpg" alt="" title="Cat Life Image" />
            </a>
        </div>
        <div class="col-md-3 col-sm-3 col-xs-4 w3gallery-grids">
            <a href="/images/g6.jpg" class="imghvr-hinge-right figure">
                <img src="/images/g6.jpg" alt="" title="Cat Life Image" />
            </a>
        </div>
        <div class="col-md-3 col-sm-3 col-xs-4 w3gallery-grids">
            <a href="/images/g7.jpg" class="imghvr-hinge-right figure">
                <img src="/images/g7.jpg" alt="" title="Cat Life Image" />
            </a>
        </div>
        <div class="col-md-3 col-sm-3 col-xs-4 w3gallery-grids">
            <a href="/images/g8.jpg" class="imghvr-hinge-right figure">
                <img src="/images/g8.jpg" alt="" title="Cat Life Image" />
            </a>
        </div>
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="modal-info">
                    <h4>Dog Life</h4>
                    <img src="${pageContext.request.contextPath}/images/dog1.png" alt=" " class="img-responsive" />
